...
public class StockSelectorForOneList {
    ...
    private StockSelectionChangedListener stockSelectionChangedListener;

    public StockSelectorForOneList(List<Stock> stocks, StockSelectionChangedListener stockSelectionChangedListener) {
